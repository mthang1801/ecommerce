...
const TermsAndPrivacy = ({setDisabledNext, scroll}) => { 
  ...
  return (
    <TermsAndPrivacyContainer mobileView={mobileView} tabletView={tabletView}>
      <article>
        <div >
          ...
          <p>
            ...
            use of{" "}
            <span style={{fontWeight:"bold"}}>Company Name</span>'s
            Website, located at{" "}
            <span style={{fontWeight:"bold"}}>Website.com</span>.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use{" "}
            <span style={{fontWeight:"bold"}}>Website Name</span> if
          ...
          <p>
            ...
            from{" "}
            <span style={{fontWeight:"bold"}}>Website Name</span> for
          ...
          <p>
            ...
            opinions of{" "}
            <span style={{fontWeight:"bold"}}>Company Name</span>,its
          ...
          <p>
            You hereby grant{" "}
            <span style={{fontWeight:"bold"}}>Company Name</span> a
      ...
      <FormControlLabel
        ...
        label="Tôi đồng ý với các điều khoản và chính sách trên"
      />
