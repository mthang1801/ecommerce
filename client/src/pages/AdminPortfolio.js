...
import AdminPortfolioNavigations from "../components/Admin/Portfolio/AdminPortfolioNavigations"
...
const AdminPortfolio = ({fetchAdminPortfolioList}) => {
  ...
  return (
    <AdminLayout>
      <AdminPortfolioNavigations navigation={navigation} setNavigation={val => setNavigation(val)}/>
...
export default connect(null, mapDispatchToProps)(AdminPortfolio)
